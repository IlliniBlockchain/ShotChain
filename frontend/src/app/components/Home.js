...
export default function Home() {
  ...
  const handleVoteClick = async (vote, commentId, questionId) => {
    try {
      // Assuming the server expects 'voteType' as 'upvote' or 'downvote' and 'commentId' for identification
      console.log(vote, commentId, questionId)
      const response = await axios.patch(`http://localhost:3001/questions/${questionId}/vote`, {
        userId: commentId,
        vote: vote,
      });
      console.log(response.data);
      // Here, you might want to update your component state to reflect the new vote count
    } catch (error) {
