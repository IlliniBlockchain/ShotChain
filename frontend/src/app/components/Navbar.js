        ...
        <>
          <div className="">
            <div className="relative flex h-16 items-center justify-between">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          window.location.href == item.url ? 'bg-gray-900 text-white' : 'text-black hover:bg-gray-700 hover:text-white',
                          'rounded-md px-3 py-2 mt-0.5 text-sm font-medium'
                        )}
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 text-black">
                {isConnected ? <button
                  type="button"
                ...
                >
                  ...
                  type="button"
                  className="mr-8 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  onClick={connectWallet}
                >
                  Connect Wallet
                </button>}
                <p className='mr-8 font-semibold'>{account.name}</p>
                <p className='mr-8 font-semibold'>🏆{account.rep}</p>
